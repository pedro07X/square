...
function setup() {
  ...
  ground.scale = 1.5;
gameOver = createSprite (width -700,50,10,10);
gameOver.addImage(over);

  restart = createSprite(width -700,90,10,10);
  restart.addImage(botton);
  restart.scale = 0.7
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(width,170,10,40);
